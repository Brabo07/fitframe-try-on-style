...
// Added state for specific product selection
const TryOn = () => {
  const [showARTryOn, setShowARTryOn] = useState(false);
  const [productToTryOn, setProductToTryOn] = useState<Tables<"glasses_products"> | undefined>(undefined);
...
  const handleTryOnStart = (product?: Tables<"glasses_products">) => {
    setProductToTryOn(product);
    setShowARTryOn(true);
  };
  
  const handleTryOnClose = () => {
    setShowARTryOn(false);
    // Optionally clear the product when closing
    // setProductToTryOn(undefined); 
  };

  const features = [
    // ... (features array kept as is) ...
    {
      icon: Camera,
...
              size="lg"
              variant="premium"
              onClick={() => handleTryOnStart()} // Start with no specific product
...
                    onClick={() => handleTryOnStart(product)} // Start AR with this specific product
                  >
...
      {showARTryOn && <ARTryOn onClose={handleTryOnClose} product={productToTryOn} />} 
      {/* Passed the selected product */}
    </div>
  );
};
